package com.katalon.utility;

import com.google.common.base.Function;
import com.katalon.drivermanager.ManageDriver;
...
//*************************** Action Methods ***************************************//
    ...
    public WebElement waitUntilVisibilityOfElementLocated(WebElement webElementName, int time) {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(time));
        return wait.until(ExpectedConditions.visibilityOf(webElementName));
    }
    ...
    public WebElement waitForElementWithFluentWait(WebElement webElementName, int time, int pollingTime) {
        Wait<WebDriver> wait = new FluentWait<WebDriver>(driver)
                .withTimeout(Duration.ofSeconds(time))
                .pollingEvery(Duration.ofSeconds(pollingTime))
                .ignoring(NoSuchElementException.class);
